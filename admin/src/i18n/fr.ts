...
export const fr = {
  ...
  "products.column.images": "Photos",

  // ── Photos d'un produit (D-054, D-059, D-062) ──
  "productImages.title": "Photos du produit",
  "productImages.description": "Gérez les photos de « {name} ».",
  "productImages.firstIsCover":
    "La PREMIÈRE photo est celle que le portail affiche sur la carte du produit. Utilisez les flèches pour changer l'ordre.",
  "productImages.cover": "Mise en avant",
  "productImages.empty":
    "Aucune photo. Le portail affiche pour l'instant un visuel de remplacement propre à la catégorie.",
  "productImages.none": "aucune",
  "productImages.add": "Ajouter une photo",
  "productImages.uploading": "Envoi…",
  "productImages.added": "Photo ajoutée.",
  "productImages.removed": "Photo retirée.",
  "productImages.remove": "Retirer la photo {position}",
  "productImages.moveBack": "Reculer la photo {position}",
  "productImages.moveForward": "Avancer la photo {position}",
  "productImages.alt": "{name} — photo {position}",
  "productImages.manageFor": "Gérer les photos de {name}",
  "productImages.constraints": "JPEG, PNG ou WebP. 5 Mo maximum, {max} photos par produit.",
  "productImages.limitReached": "Limite atteinte : {max} photos par produit.",
  "productImages.tooLarge": "Ce fichier dépasse 5 Mo.",
