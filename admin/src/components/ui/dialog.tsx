...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        // `bg-overlay` et non `bg-black` : la couleur du voile vient du thème
        // (src/index.css), comme pour le panneau latéral. Aucune couleur en dur dans un
        // composant — la palette doit rester remplaçable en éditant ce seul fichier.
